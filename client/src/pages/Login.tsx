...
import { IoBookOutline, IoBulbOutline, IoRocketOutline } from "react-icons/io5";
          ...
          <div className="flex gap-3 justify-center items-center w-3/5 pb-2">
            <div className="flex flex-col justify-center items-center">
              <div className="bg-purple-500 rounded-full p-1">
                <HiMagnifyingGlass className="text-white text-4xl p-1 " />
              </div>
              <p className="text-white text-md">Discover</p>
            </div>
            <div className="flex flex-col justify-center items-center">
              <div className="bg-purple-500 rounded-full p-1">
                <IoBookOutline className="text-white text-4xl p-1 " />
              </div>
              <p className="text-white text-md">Learn</p>
            </div>
            <div className="flex flex-col justify-center items-center">
              <div className="bg-purple-500 rounded-full p-1">
                <IoRocketOutline className="text-white text-4xl p-1 " />
              </div>
              <p className="text-white text-md">Grow</p>
            </div>
            <div className="flex flex-col justify-center items-center">
              <div className="bg-purple-500 rounded-full p-1">
                <IoBulbOutline className="text-white text-4xl p-1 " />
              </div>
          ...
          <div className="form-wrapper flex flex-col items-center justify-center h-full w-5/6 ">
            ...
            <div className="form-element flex flex-col justify-items-start w-full gap-4">
              ...
              <div className="relative w-full">
                ...
                <button className="absolute right-0 inset-y-16 pt-1 text-xs text-red-600 hover:text-red-800">
                  Forgot password?
                </button>
              </div>

              <div className="w-full flex flex-col">
                <label className="p-1">Select Role</label>
                <div className="flex justify-start gap-6 py-2">
                  <label className="flex items-center">
                    ...
                    <span
                      className={`ml-2 ${
                        role === "student" ? "text-black" : "text-black"
                      } text-lg `}
                    >
                      Student
                    </span>
                  ...
                  <label className="flex items-center">
                    ...
                    <span
                      className={`ml-2 ${
                        role === "course-creator" ? "text-black" : "text-black"
                      } text-lg `}
                    >
                      Course Creator
                    </span>
              ...
              <div className="flex justify-start pt-6 text-sm">
                <p>
                  Don&apos;t have an account?
                  <span className="px-2 text-blue-700 cursor-pointer hover:text-blue-900 underline underline-offset-4">
                    Sign up
                  </span>
                </p>
              </div>
